import{_ as r,D as e,c as d,I as s,w as a,aa as p,o as h,l as t,a as i}from"./chunks/framework.B-_8KZRP.js";const C=JSON.parse('{"title":"Templated Links","description":"","frontmatter":{"aside":false,"head":[["link",{"rel":"canonical","href":"https://pointw-dev.github.io/halchemy/guide/templates/using.html"}]]},"headers":[],"relativePath":"guide/templates/using.md","filePath":"guide/templates/using.md"}'),u={name:"guide/templates/using.md"},k=p(`<h1 id="templated-links" tabindex="-1">Templated Links <a class="header-anchor" href="#templated-links" aria-label="Permalink to &quot;Templated Links&quot;">​</a></h1><p>One of the features of HAL is the ability to use templated links. These are links whose href has one or more placeholders that you can fill in with values. For example, an <code>orders</code> collection resource may have the following links:</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
`),t("span",{class:"line"},[t("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    ."),t("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}},"get"),t("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"();")])])])],-1),E=p(`<p>If you do not supply a value for a template placeholder, the placeholder is simply removed.</p><p>The syntax for templated links is specified in <a href="https://datatracker.ietf.org/doc/html/rfc6570" target="_blank" rel="noreferrer">RFC 6570</a> and is very expressive. Here are some sample templates, and what the URL looks like when filled with these values:</p><table><tr><td class="header">Templated URL</td><td class="header">Values</td><td class="header">Resulting URL</td></tr><tr><td><pre class="tableSnippet">/path/{foo}</pre></td><td><pre class="tableSnippet">{&quot;foo&quot;:&quot;321&quot;}</pre></td><td><pre class="tableSnippet">/path/321</pre></td></tr><tr><td><pre class="tableSnippet">/has/{foo}/multiples/{bar}</pre></td><td><pre class="tableSnippet">{
  ...
  &quot;postId&quot;:&quot;200&quot;,
  &quot;comments&quot;:&quot;all&quot;
}</pre></td><td><pre class="tableSnippet">/users/100/posts/200?comments=all</pre></td></tr><tr><td><pre class="tableSnippet">/path?fixedParam=value{&amp;foo}</pre></td><td><pre class="tableSnippet">{&quot;foo&quot;:&quot;bar&quot;}</pre></td><td><pre class="tableSnippet">/path?fixedParam=value&amp;foo=bar</pre></td></tr></table>`,3);function g(m,y,b,f,_,F){const l=e("tab"),n=e("future-languages"),o=e("tabs");return h(),d("div",null,[k,s(o,null,{default:a(()=>[s(l,{name:"Python"},{default:a(()=>[c]),_:1}),s(l,{name:"JavaScript"},{default:a(()=>[q]),_:1}),s(n)]),_:1}),E])}const v=r(u,[["render",g]]);export{C as __pageData,v as default};
