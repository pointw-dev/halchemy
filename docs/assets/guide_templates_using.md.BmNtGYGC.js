import{_ as r,y as e,a as d,G as s,w as a,aa as l,o as h,h as t,J as i}from"./chunks/framework.Bu-ijBxq.js";const C=JSON.parse('{"title":"Templated Links","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"guide/templates/using.md","filePath":"guide/templates/using.md"}'),u={name:"guide/templates/using.md"},k=l(`<h1 id="templated-links" tabindex="-1">Templated Links <a class="header-anchor" href="#templated-links" aria-label="Permalink to &quot;Templated Links&quot;">​</a></h1><p>One of the features of HAL is the ability to use templated links. These are links whose href has one or more placeholders that you can fill in with values. For example, an <code>orders</code> collection resource may have the following links:</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
